...
public class mvc_Action__ControlerActionMethodHeader_410840083 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__ControlerActionMethodHeader_410840083() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__ControlerActionMethodHeader_410840083(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ControlerActionMethodHeader", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ControlerActionMethodHeader''");
...
_template_buffer.append("	public void ");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append("() {");
_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "ControlerActionMethodImplementation"));
_template_buffer.append(manager.action(current, "QuitterActionImplementation"));_template_buffer.append('\n');
_template_buffer.append("	}");
_template_buffer.append('\n');
