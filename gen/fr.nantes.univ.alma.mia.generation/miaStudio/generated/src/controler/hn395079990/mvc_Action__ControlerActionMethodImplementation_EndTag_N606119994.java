...
public class mvc_Action__ControlerActionMethodImplementation_EndTag_N606119994 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__ControlerActionMethodImplementation_EndTag_N606119994() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__ControlerActionMethodImplementation_EndTag_N606119994(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ControlerActionMethodImplementation$EndTag", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ControlerActionMethodImplementation$EndTag''");
...
_template_buffer.append("		// End of user code for ");
