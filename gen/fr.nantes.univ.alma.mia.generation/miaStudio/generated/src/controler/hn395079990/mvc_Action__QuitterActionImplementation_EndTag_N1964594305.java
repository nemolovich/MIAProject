...
public class mvc_Action__QuitterActionImplementation_EndTag_N1964594305 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__QuitterActionImplementation_EndTag_N1964594305() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__QuitterActionImplementation_EndTag_N1964594305(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"QuitterActionImplementation$EndTag", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''QuitterActionImplementation$EndTag''");
