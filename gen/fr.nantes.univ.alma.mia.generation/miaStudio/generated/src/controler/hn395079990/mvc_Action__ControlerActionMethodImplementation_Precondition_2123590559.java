...
public class mvc_Action__ControlerActionMethodImplementation_Precondition_2123590559 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__ControlerActionMethodImplementation_Precondition_2123590559() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__ControlerActionMethodImplementation_Precondition_2123590559(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ControlerActionMethodImplementation$Precondition", argument.getClass().getName(),
	...
	public Boolean runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ControlerActionMethodImplementation$Precondition''");
	...
	public Boolean __invoke_user_code__(final com.mia.formation.mvc.Action current, final com.mia.openapi.gen.Context context, final com.mia.openapi.gen.GenerationServicesManager manager)
{
