...
public class mvc_Action__QuitterActionImplementation_N1563735649 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__QuitterActionImplementation_N1563735649() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__QuitterActionImplementation_N1563735649(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"QuitterActionImplementation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''QuitterActionImplementation''");
...
_template_buffer.append(manager.action(current, "QuitterActionImplementation$BeginTag"));_template_buffer.append('\n');
_template_buffer.append("		//On veut fermer toutes les fenetres ouvertes");
_template_buffer.append('\n');
_template_buffer.append("		Display.getCurrent().dispose();");
_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "QuitterActionImplementation$EndTag"));
