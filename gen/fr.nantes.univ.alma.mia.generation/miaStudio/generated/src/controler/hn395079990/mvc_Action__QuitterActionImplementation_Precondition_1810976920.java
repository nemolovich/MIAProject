...
public class mvc_Action__QuitterActionImplementation_Precondition_1810976920 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__QuitterActionImplementation_Precondition_1810976920() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__QuitterActionImplementation_Precondition_1810976920(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"QuitterActionImplementation$Precondition", argument.getClass().getName(),
	...
	public Boolean runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''QuitterActionImplementation$Precondition''");
