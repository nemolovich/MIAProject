...
public class mvc_Action__NextPageModelImport_Precondition_N1054162874 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__NextPageModelImport_Precondition_N1054162874() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__NextPageModelImport_Precondition_N1054162874(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"NextPageModelImport$Precondition", argument.getClass().getName(),
	...
	public Boolean runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''NextPageModelImport$Precondition''");
