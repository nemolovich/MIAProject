...
public class mvc_View__ControlerImplementation_Filename_835202932 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ControlerImplementation_Filename_835202932() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ControlerImplementation_Filename_835202932(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ControlerImplementation$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ControlerImplementation$Filename''");
...
_template_buffer.append("com/mia/banque/ui/controler/swt/");
