...
public class mvc_View__CreateControlerInterface_Filename_N837039119 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__CreateControlerInterface_Filename_N837039119() {
		//Do nothing
	}

	//For internal use only
	mvc_View__CreateControlerInterface_Filename_N837039119(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"CreateControlerInterface$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''CreateControlerInterface$Filename''");
...
_template_buffer.append("com/mia/banque/ui/controler/I");
_template_buffer.append(manager.action(current, "ModelName"));_template_buffer.append("Controler.java");
