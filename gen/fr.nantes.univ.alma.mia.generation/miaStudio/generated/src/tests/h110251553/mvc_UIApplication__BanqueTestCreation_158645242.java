...
public class mvc_UIApplication__BanqueTestCreation_158645242 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_UIApplication__BanqueTestCreation_158645242() {
		//Do nothing
	}

	//For internal use only
	mvc_UIApplication__BanqueTestCreation_158645242(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"BanqueTestCreation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''BanqueTestCreation''");
...
_template_buffer.append(manager.action(current, "AllModelsImport"));_template_buffer.append('\n');
...
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append(manager.action(current, "ModelTest"));_template_buffer.append('\n');
_template_buffer.append("}");
_template_buffer.append('\n');
