...
public class mvc_UIApplication__BusinessViewTest_Filename_N10308648 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_UIApplication__BusinessViewTest_Filename_N10308648() {
		//Do nothing
	}

	//For internal use only
	mvc_UIApplication__BusinessViewTest_Filename_N10308648(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"BusinessViewTest$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''BusinessViewTest$Filename''");
...
_template_buffer.append("com/mia/banque/model/impl/BusinessViewProtoLauncher.java");
