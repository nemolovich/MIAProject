...
public class mvc_UIApplication__BanqueTestCreation_Filename_1809450188 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_UIApplication__BanqueTestCreation_Filename_1809450188() {
		//Do nothing
	}

	//For internal use only
	mvc_UIApplication__BanqueTestCreation_Filename_1809450188(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"BanqueTestCreation$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''BanqueTestCreation$Filename''");
...
_template_buffer.append("com/mia/banque/model/impl/");
_template_buffer.append(manager.action(current, "ModelName"));_template_buffer.append("Test.java");
