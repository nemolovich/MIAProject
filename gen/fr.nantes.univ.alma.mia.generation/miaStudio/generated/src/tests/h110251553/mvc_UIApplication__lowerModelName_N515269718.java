...
public class mvc_UIApplication__lowerModelName_N515269718 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_UIApplication__lowerModelName_N515269718() {
		//Do nothing
	}

	//For internal use only
	mvc_UIApplication__lowerModelName_N515269718(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"lowerModelName", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''lowerModelName''");
