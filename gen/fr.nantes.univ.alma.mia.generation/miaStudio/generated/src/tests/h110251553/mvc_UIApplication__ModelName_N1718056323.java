...
public class mvc_UIApplication__ModelName_N1718056323 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_UIApplication__ModelName_N1718056323() {
		//Do nothing
	}

	//For internal use only
	mvc_UIApplication__ModelName_N1718056323(int anyInt, List anyList) {
