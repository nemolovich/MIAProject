...
public class mvc_Model__AttributeCreation_N1562786633 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__AttributeCreation_N1562786633() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__AttributeCreation_N1562786633(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"AttributeCreation", argument.getClass().getName(),
	...
	public Object runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''AttributeCreation''");
	...
	public Object __invoke_user_code__(final com.mia.formation.mvc.Model current, final com.mia.openapi.gen.Context context, final com.mia.openapi.gen.GenerationServicesManager manager)
{
