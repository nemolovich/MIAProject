...
public class mvc_Model__ModelImplementation_Filename_N1898236401 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ModelImplementation_Filename_N1898236401() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ModelImplementation_Filename_N1898236401(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ModelImplementation$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ModelImplementation$Filename''");
