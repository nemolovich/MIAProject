...
public class mvc_Model__InterfaceCreation_Filename_N1759728718 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__InterfaceCreation_Filename_N1759728718() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__InterfaceCreation_Filename_N1759728718(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"InterfaceCreation$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''InterfaceCreation$Filename''");
...
_template_buffer.append("com/mia/banque/model/I");
