...
public class mvc_Model__DeclareList_924437828 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__DeclareList_924437828() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__DeclareList_924437828(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"DeclareList", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''DeclareList''");
