...
public class mvc_Model__DeclareList_Precondition_N662527725 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__DeclareList_Precondition_N662527725() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__DeclareList_Precondition_N662527725(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"DeclareList$Precondition", argument.getClass().getName(),
	...
	public Boolean runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''DeclareList$Precondition''");
	...
	public Boolean __invoke_user_code__(final com.mia.formation.mvc.Model current, final com.mia.openapi.gen.Context context, final com.mia.openapi.gen.GenerationServicesManager manager)
{
