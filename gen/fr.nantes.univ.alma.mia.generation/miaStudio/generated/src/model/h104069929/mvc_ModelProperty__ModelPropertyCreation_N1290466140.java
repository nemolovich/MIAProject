...
public class mvc_ModelProperty__ModelPropertyCreation_N1290466140 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__ModelPropertyCreation_N1290466140() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__ModelPropertyCreation_N1290466140(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ModelPropertyCreation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ModelPropertyCreation''");
