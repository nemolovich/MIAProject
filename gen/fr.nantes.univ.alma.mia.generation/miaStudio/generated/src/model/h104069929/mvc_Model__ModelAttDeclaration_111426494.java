...
public class mvc_Model__ModelAttDeclaration_111426494 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ModelAttDeclaration_111426494() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ModelAttDeclaration_111426494(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ModelAttDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ModelAttDeclaration''");
