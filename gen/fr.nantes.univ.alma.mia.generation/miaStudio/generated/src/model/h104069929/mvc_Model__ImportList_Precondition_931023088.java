...
public class mvc_Model__ImportList_Precondition_931023088 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ImportList_Precondition_931023088() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ImportList_Precondition_931023088(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ImportList$Precondition", argument.getClass().getName(),
	...
	public Boolean runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ImportList$Precondition''");
