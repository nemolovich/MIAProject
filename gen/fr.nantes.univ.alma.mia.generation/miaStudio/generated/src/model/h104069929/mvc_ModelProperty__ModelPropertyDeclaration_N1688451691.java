...
public class mvc_ModelProperty__ModelPropertyDeclaration_N1688451691 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__ModelPropertyDeclaration_N1688451691() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__ModelPropertyDeclaration_N1688451691(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ModelPropertyDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ModelPropertyDeclaration''");
...
_template_buffer.append('\n');
_template_buffer.append("	 * Returns the ");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(" property value");
_template_buffer.append('\n');
_template_buffer.append("	 * @return {@link String} - The ");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(" property value");
_template_buffer.append('\n');
_template_buffer.append("	 */");
_template_buffer.append('\n');
...
_template_buffer.append("	/**");
_template_buffer.append('\n');
_template_buffer.append("	 * Set the ");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(" property value");
_template_buffer.append('\n');
_template_buffer.append("	 * @param ");
_template_buffer.append(manager.action(current, "lowerName"));_template_buffer.append(" {@link String} - The new ");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(" value");
_template_buffer.append('\n');
_template_buffer.append("	 */");
_template_buffer.append('\n');
