...
public class mvc_Model__ImportList_N1797676473 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ImportList_N1797676473() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ImportList_N1797676473(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ImportList", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ImportList''");
