...
public class mvc_View__ViewDeclaration_Filename_1911649563 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ViewDeclaration_Filename_1911649563() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ViewDeclaration_Filename_1911649563(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ViewDeclaration$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ViewDeclaration$Filename''");
