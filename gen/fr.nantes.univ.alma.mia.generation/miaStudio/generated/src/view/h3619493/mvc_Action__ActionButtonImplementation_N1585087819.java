...
public class mvc_Action__ActionButtonImplementation_N1585087819 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__ActionButtonImplementation_N1585087819() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__ActionButtonImplementation_N1585087819(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ActionButtonImplementation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ActionButtonImplementation''");
...
_template_buffer.append("		this.btn");
_template_buffer.append(manager.action(current, "CapitalFirst"));_template_buffer.append(" = new Button(grpButtons, SWT.NONE);");
_template_buffer.append('\n');
_template_buffer.append("		this.btn");
_template_buffer.append(manager.action(current, "CapitalFirst"));_template_buffer.append(".setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, true, 1, 1));");
_template_buffer.append('\n');
_template_buffer.append("		this.btn");
_template_buffer.append(manager.action(current, "CapitalFirst"));_template_buffer.append(".setText(\"");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append("\");");
_template_buffer.append('\n');
_template_buffer.append("		this.btn");
_template_buffer.append(manager.action(current, "CapitalFirst"));_template_buffer.append(".addSelectionListener(new SelectionAdapter() {");
_template_buffer.append('\n');
