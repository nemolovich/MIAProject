...
public class mvc_Model__ModelViewListDeclaration_1212867602 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ModelViewListDeclaration_1212867602() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ModelViewListDeclaration_1212867602(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ModelViewListDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ModelViewListDeclaration''");
...
_template_buffer.append(manager.action(current, "lowerName"));_template_buffer.append("sList;");
