...
public class mvc_Action__ActionButtonDeclaration_1085455703 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__ActionButtonDeclaration_1085455703() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__ActionButtonDeclaration_1085455703(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ActionButtonDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ActionButtonDeclaration''");
...
_template_buffer.append("	private Button btn");
_template_buffer.append(manager.action(current, "CapitalFirst"));_template_buffer.append(";");
