...
public class mvc_Action__ActionMethodImplementation_1883964964 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__ActionMethodImplementation_1883964964() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__ActionMethodImplementation_1883964964(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ActionMethodImplementation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ActionMethodImplementation''");
