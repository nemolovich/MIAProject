...
public class mvc_ModelProperty__ModelViewLabel_N2021294977 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__ModelViewLabel_N2021294977() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__ModelViewLabel_N2021294977(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ModelViewLabel", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ModelViewLabel''");
...
_template_buffer.append(manager.action(current, "lowerName"));_template_buffer.append("Field = new Text(this, SWT.BORDER);");
_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append(manager.action(current, "lowerName"));_template_buffer.append("Field.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,");
_template_buffer.append('\n');
_template_buffer.append("				false, 1, 1));");
_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append(manager.action(current, "lowerName"));_template_buffer.append("Field.setText(this.model.get");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append("());");
_template_buffer.append('\n');
_template_buffer.append("	");
