...
public class mvc_View__ActionDeclaration_N1661339366 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ActionDeclaration_N1661339366() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ActionDeclaration_N1661339366(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ActionDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ActionDeclaration''");
