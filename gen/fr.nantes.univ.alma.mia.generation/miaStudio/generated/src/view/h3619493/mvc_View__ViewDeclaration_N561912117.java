...
public class mvc_View__ViewDeclaration_N561912117 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ViewDeclaration_N561912117() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ViewDeclaration_N561912117(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ViewDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ViewDeclaration''");
...
_template_buffer.append(manager.action(current, "ActionDeclaration"));_template_buffer.append('\n');
_template_buffer.append("}");
