...
public class mvc_View__ViewImplementation_Filename_1209877477 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ViewImplementation_Filename_1209877477() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ViewImplementation_Filename_1209877477(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ViewImplementation$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ViewImplementation$Filename''");
...
_template_buffer.append("com/mia/banque/ui/view/swt/");
