...
public class mvc_View__nbActions_339865215 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__nbActions_339865215() {
		//Do nothing
	}

	//For internal use only
	mvc_View__nbActions_339865215(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"nbActions", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''nbActions''");
