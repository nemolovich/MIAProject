...
public class mvc_View__InterfacesCreation_Filename_N387902333 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__InterfacesCreation_Filename_N387902333() {
		//Do nothing
	}

	//For internal use only
	mvc_View__InterfacesCreation_Filename_N387902333(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"InterfacesCreation$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''InterfacesCreation$Filename''");
...
_template_buffer.append("com/mia/banque/ui/view/I");
