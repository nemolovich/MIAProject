...
public class mvc_View__InterfacesCreation_N312094109 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__InterfacesCreation_N312094109() {
		//Do nothing
	}

	//For internal use only
	mvc_View__InterfacesCreation_N312094109(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"InterfacesCreation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''InterfacesCreation''");
...
_template_buffer.append("package com.mia.banque.ui.view;");
...
_template_buffer.append("	");
_template_buffer.append('\n');
_template_buffer.append("	public void afficherClient();");
_template_buffer.append('\n');
_template_buffer.append("	public void quitter();");
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append('\n');
_template_buffer.append("}");
